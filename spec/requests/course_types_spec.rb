...
RSpec.describe "/course_types", type: :request do
  ...
  describe "GET /index" do
    it "renders a successful response" do
      CourseType.create! valid_attributes
  ...
  describe "POST /create" do
    context "with valid parameters" do
      it "creates a new CourseType" do
        expect {
          post course_types_url, params: { course_type: valid_attributes }
        }.to change(CourseType, :count).by(1)
      end

      it "redirects to the created course_type" do
        post course_types_url, params: { course_type: valid_attributes }
        expect(response).to redirect_to(course_type_url(CourseType.last))
      end
    end

    context "with invalid parameters" do
      it "does not create a new CourseType" do
        expect {
          post course_types_url, params: { course_type: invalid_attributes }
        }.to change(CourseType, :count).by(0)
      end
  ...
  describe "PATCH /update" do
    context "with valid parameters" do
      ...
      it "updates the requested course_type" do
        course_type = CourseType.create! valid_attributes
        patch course_type_url(course_type), params: { course_type: new_attributes }
        course_type.reload
      ...
      it "redirects to the course_type" do
        ...
        patch course_type_url(course_type), params: { course_type: new_attributes }
        course_type.reload
        expect(response).to redirect_to(course_type_url(course_type))
      end
    end
    ...
    context "with invalid parameters" do
      it "renders a response with 422 status (i.e. to display the 'edit' template)" do
        course_type = CourseType.create! valid_attributes
        patch course_type_url(course_type), params: { course_type: invalid_attributes }
        expect(response).to have_http_status(:unprocessable_entity)
      end
    end
  end
