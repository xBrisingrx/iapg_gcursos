...
class SectorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sector" do
    assert_difference("Sector.count") do
      post sectors_url, params: { sector: { active: @sector.active, description: @sector.description, name: @sector.name } }
    end
  ...
  test "should update sector" do
    patch sector_url(@sector), params: { sector: { active: @sector.active, description: @sector.description, name: @sector.name } }
